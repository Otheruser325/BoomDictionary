...
export const customId = 'select_prototype_defence_level';
export const customIdPrefix = 'select_prototype_defence_level';
export async function execute(interaction) {
    try {
        ...
        return reportExecutionError({
            error,
            fallbackMessage: 'An error occurred while updating the prototype defence selection. Please try again later.',
            interaction,
            scope: 'interaction-prototype-defence-level-failed',
        });
    }
}
