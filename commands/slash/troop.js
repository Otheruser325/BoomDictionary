...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            if (error.code === 10008) {
                return interaction.followUp(`The troop embed was deleted and couldn't be recovered, please try again later.`);
                ...
                interaction.reply('An error occurred while executing the troop command. Please try again later.');
            }
        }
    },
};